...
<html>
    ...
    <body>
        ...
        <div>
            ...
            <div class="modal fade" id="modal_dmaestro" id="modal" role="dialog">
    ...
    <table class="table table-hover table-dark">
            ...
            <table class="table table-hover table-dark">
                ...
                <tbody id="tbl_cdetalle">
                    <%            Compra_Detalle cdetalle = new Compra_Detalle();
                        ...
                        tablas = cdetalle.leer();
                        for (int t = 0; t < tablas.getRowCount(); t++) {
                            out.println("<tr data-id=" + tablas.getValueAt(t, 0) + " data-id_c=" + tablas.getValueAt(t, 1) + " data-id_p=" + tablas.getValueAt(t, 2) + " data-id_t=" + tablas.getValueAt(t, 3) + ">");
                            out.println("<td>" + tablas.getValueAt(t, 0) + "</td>");
                            out.println("<td>" + tablas.getValueAt(t, 1) + "</td>");
                            out.println("<td>" + tablas.getValueAt(t, 2) + "</td>");
                            out.println("<td>" + tablas.getValueAt(t, 3) + "</td>");
                            out.println("<td>" + tablas.getValueAt(t, 4) + "</td>");
                            out.println("</tr>");
                        }
         ...
         */
        $('#tbl_cdetalle').on('click', 'tr td', function (evt) {
            var target, id, id_p, id_t, p_c_u, id_c, id_e, no_orden, fecha_orden;
            ...
            $("#txt_id_compra").val(id);
            $("#txt_no_orden_compra").val(id_c);
            $("#drop_list").val(id_p);
            $("#txt_fecha_orden").val(id_t);
            $("#modal_dmaestro").modal('show');
        });
        </script>
        <style>
