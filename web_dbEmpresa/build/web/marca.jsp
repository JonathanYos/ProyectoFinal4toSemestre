<%-- 
    Document   : marca
    Created on : 30/09/2020, 11:29:41 AM
    Author     : jarno
--%>
      ...
      <div class="collapse navbar-collapse justify-content-md-center">
        <ul class="navbar-nav">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="producto.jsp">PRODUCTOS<span class="sr-only">(current)</span></a>
          </li>
        </ul>
      </div>
    </nav>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form class="form-group col-auto" action="sr_marca" method="post">
            <div class="form-group col-auto">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="txt_marca" id="txt_marca" class="form-control" placeholder="ej. HP" required>    
                </div>
