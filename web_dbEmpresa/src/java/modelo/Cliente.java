...
public class Cliente {
    public int idcliente, genero;
    public String nombres, apellidos, nit, telefono, correo, fecha_ingreso;
    private Conexion cn;

    public Cliente(){}
    public Cliente(int idcliente, int genero, String nombres, String apellidos, String nit, String telefono, String correo, String fecha_ingreso) {
    ...
    public HashMap drop_sangre(){
        ...
        try{
            cn = new Conexion();
            String query = "select idcliente as idcliente, nombres from clientes;";
            cn.abrir_conexion();
...
public DefaultTableModel leer(){
 ...
 try{
     cn = new Conexion();
     cn.abrir_conexion();
      String query = "SELECT c.idCliente as id,c.nombres,c.apellidos,c.nit,c.genero,c.telefono,c.correo_electronico,c.fecha_ingreso FROM clientes as c;";
      ResultSet consulta = cn.conexionDB.createStatement().executeQuery(query);
 ...
 return tabla;
    ...
    public int modificar (){
        ...
        try{
            ...
            parametro.setString(5,this.getTelefono());
            parametro.setString(6,this.getCorreo());
            parametro.setInt(7, this.getIdcliente());
            retorno = parametro.executeUpdate();
            cn.cerrar_conexion();
        }catch(SQLException ex){
            System.out.println(ex.getMessage());
