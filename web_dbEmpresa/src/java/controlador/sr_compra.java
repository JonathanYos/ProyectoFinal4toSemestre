...
public class sr_compra extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            compra = new Compra(Integer.valueOf(request.getParameter("txt_id_compra")), Integer.valueOf(request.getParameter("txt_no_orden_compra")), Integer.valueOf(request.getParameter("drop_proveedor")), request.getParameter("txt_fecha_orden"), request.getParameter("txt_fecha_ingreso"));             
